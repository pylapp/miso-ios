...
public enum iPhoneDevice: CustomStringConvertible, Sendable {
    ...
    public init(_ width: Double, _ height: Double, _ safeAreaBottom: CGFloat = 0) {
        ...
        case 2_868: // 956 x @3 (16 Pro max, 17 Pro Max)
            self = .proMax16
        default:
            ML.warning("iPhone device not recognized (with max dimension \(maxDimension)), please submit an issue with the device reference and computed dimension (https://github.com/Orange-OpenSource/miso-ios/issues)")
