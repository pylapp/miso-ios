...
struct MISOWCAG21RatioTests {
    ...
    func whiteColorOnBrandSurfacesMustFailFor4_5to1() throws {
        let foregroundColor = "#FFFFFFFF"
    ...
    @Test("Brand colors on Brand Primary / Secondary / Tertiary must fail for all", .enabled(if: Self.doesRunOniOS))
    func brandColorsOnBrandSurfaceMustFailForAll() throws {
        let backgroundColor = "#FF7900FF"
    ...
    @Test("Brand colors on Status Warning Muted must fail for all", .enabled(if: Self.doesRunOniOS))
    func brandColorsOnOpacitySunSurfaceMustFailForAll() throws {
    ...
    @Test("Brand colors on Status Positive Muted", .enabled(if: Self.doesRunOniOS))
    func brandColorsOnMalachiteSurface() throws {
    ...
    @Test("Brand colors on Status Info Muted", .enabled(if: Self.doesRunOniOS))
    func brandColorsOnOpacityDodgerBlueSurface() throws {
    ...
    @Test("Brand colors on Status Negative Muted must fail for all", .enabled(if: Self.doesRunOniOS))
    func brandColorsOnOpacityScarletSurfaceMustFailForAll() throws {
    ...
    func blackColorOnBrandPrimarySecondaryTertiarySurfaceMustPassForAll() throws {
        ...
        var backgroundColor = "#FF7900FF" // Brand brand color Brand 500
        var ratio = MISOWCAG21Ratio.contrastRatios(foregroundColor, backgroundColor)!
        #expect(ratio.meets3to1 == true, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == true, "Ratio = \(ratio.ratio)")

        backgroundColor = "#FF7900FF" // Brand brand color Brand 500
        ratio = MISOWCAG21Ratio.contrastRatios(foregroundColor, backgroundColor)!
        #expect(ratio.meets3to1 == true, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == true, "Ratio = \(ratio.ratio)")
    }
    ...
    @Test("Black, white and brand colors on Status Accent Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsOnStatusAccentMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
        let foregroundWhite = "#FFFFFFFF"

        var backgroundColor = "#F9F5F0FF" // Brand brand color Warm gray 100
        var ratio = MISOWCAG21Ratio.contrastRatios(foregroundBlack, backgroundColor)!
        #expect(ratio.meets3to1 == true, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == true, "Ratio = \(ratio.ratio)")
        ratio = MISOWCAG21Ratio.contrastRatios(foregroundBrandLight, backgroundColor)!
        #expect(ratio.meets3to1 == false, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == false, "Ratio = \(ratio.ratio)")

        backgroundColor = "#353228FF" // Brand brand color Warm gray 500
        ratio = MISOWCAG21Ratio.contrastRatios(foregroundWhite, backgroundColor)!
        #expect(ratio.meets3to1 == true, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == true, "Ratio = \(ratio.ratio)")
        ratio = MISOWCAG21Ratio.contrastRatios(foregroundBrandDark, backgroundColor)!
        #expect(ratio.meets3to1 == true, "Ratio = \(ratio.ratio)")
        #expect(ratio.meets4_5to1 == false, "Ratio = \(ratio.ratio)")
    }
    ...
    @Test("Black, white and brand colors on Status Info Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsOnStatusInfoMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
        let foregroundWhite = "#FFFFFFFF"
    ...
    @Test("Black, white and brand colors on Status Negative Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsBlackColorsOnStatusNegativeMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
        let foregroundWhite = "#FFFFFFFF"
    ...
    @Test("Black, white and brand colors on Status Neutral Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsBlackColorsOnStatusNeutralMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
    ...
    @Test("Black, white and brand colors on Status Positive Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsOnStatusPositiveMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
        let foregroundWhite = "#FFFFFFFF"
    ...
    @Test("Black, white, brand colors on Status Warning Muted", .enabled(if: Self.doesRunOniOS))
    func blackWhiteBrandColorsOnStatusWarningMutedSurface() throws {
        let foregroundBlack = "#000000FF"
        let foregroundBrandLight = "#FF7900FF" // Brand brand color Brand 500
        let foregroundBrandDark = "#F15E00FF" // Brand brand color Brand 550
        let foregroundWhite = "#FFFFFFFF"
