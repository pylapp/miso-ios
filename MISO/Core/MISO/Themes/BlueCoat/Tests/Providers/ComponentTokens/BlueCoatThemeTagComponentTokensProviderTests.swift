...
struct BlueCoatThemeTagComponentTokensProviderTests {

    private var provider: BlueCoatThemeTagComponentTokensProvider

    init() {
        provider = BlueCoatThemeTagComponentTokensProvider()
    }
