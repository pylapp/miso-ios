...
struct BlueCoatThemeTextAreaComponentTokensProviderTests {

    private var provider: BlueCoatThemeTextAreaComponentTokensProvider

    init() {
        provider = BlueCoatThemeTextAreaComponentTokensProvider()
    }
