...
struct BlueCoatThemeSkeletonComponentTokensProviderTests {

    private var provider: BlueCoatThemeSkeletonComponentTokensProvider

    init() {
        provider = BlueCoatThemeSkeletonComponentTokensProvider()
    }
