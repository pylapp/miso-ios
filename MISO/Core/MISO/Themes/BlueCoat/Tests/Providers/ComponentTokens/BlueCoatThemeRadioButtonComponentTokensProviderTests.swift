...
struct BlueCoatThemeRadioButtonComponentTokensProviderTests {

    private var provider: BlueCoatThemeRadioButtonComponentTokensProvider

    init() {
        provider = BlueCoatThemeRadioButtonComponentTokensProvider()
    }
