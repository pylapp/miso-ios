...
struct BlueCoatThemeButtonComponentTokensProviderTests {

    private var provider: BlueCoatThemeButtonComponentTokensProvider

    init() {
        provider = BlueCoatThemeButtonComponentTokensProvider()
    }
