...
struct BlueCoatThemeListItemComponentTokensProviderTests {

    private var provider: BlueCoatThemeListItemComponentTokensProvider

    init() {
        provider = BlueCoatThemeListItemComponentTokensProvider()
    }
