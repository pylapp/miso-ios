...
struct BlueCoatThemeAccordionComponentTokensProviderTests {

    private var provider: BlueCoatThemeAccordionComponentTokensProvider

    init() {
        provider = BlueCoatThemeAccordionComponentTokensProvider()
    }
