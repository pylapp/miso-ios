...
struct BlueCoatThemeTextInputComponentTokensProviderTests {

    private var provider: BlueCoatThemeTextInputComponentTokensProvider

    init() {
        provider = BlueCoatThemeTextInputComponentTokensProvider()
    }
