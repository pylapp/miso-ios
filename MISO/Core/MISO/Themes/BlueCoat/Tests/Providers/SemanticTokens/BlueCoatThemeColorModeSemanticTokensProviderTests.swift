...
struct BlueCoatThemeColorModeSemanticTokensProviderTests {

    private var provider: BlueCoatThemeColorModeSemanticTokensProvider

    init() {
        provider = BlueCoatThemeColorModeSemanticTokensProvider()
    }
