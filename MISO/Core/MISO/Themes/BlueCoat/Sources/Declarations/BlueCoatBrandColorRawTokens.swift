...
/// This enum helps to add new **color raw tokens** exclusive to this ``BlueCoatTheme``.
...
///
/// - Since: 1.0.0
@frozen public enum BlueCoatBrandColorRawTokens {}

/// `BlueCoat` can be considered as default theme for MISO
/// - Since: 1.0.0
public typealias DefaultBrandColorRawTokens = BlueCoatBrandColorRawTokens
