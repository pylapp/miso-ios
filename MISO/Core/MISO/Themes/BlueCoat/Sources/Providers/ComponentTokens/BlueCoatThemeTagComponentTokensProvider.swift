...
/// - Since: 1.0.0
public typealias DefaultTagComponentTokensProvider = BlueCoatThemeTagComponentTokensProvider
...
///
/// - Since: 1.0.0
open class BlueCoatThemeTagComponentTokensProvider: AllTagComponentTokensProvider {
    ...
    ///    - spaces: Provider for spaces semantic tokens. If nil, a default one will be used (``BlueCoatThemeSpaceSemanticTokensProvider``)
    ...
    {
        ML.debug("Init of BlueCoatThemeTagComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "BlueCoatThemeTagComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of TagComponentTokens is not here but in Core/MISO/Themes/BlueCoat/Values/ComponentTokens/BlueCoatTheme+TagComponentTokens.swift
    // This declaration of BlueCoatThemeTagComponentTokensProvider is here also to allow to write documentation.
}
