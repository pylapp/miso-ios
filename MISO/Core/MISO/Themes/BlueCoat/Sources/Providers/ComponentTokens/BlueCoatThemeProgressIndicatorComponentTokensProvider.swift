...
/// It implements also the protocol `ProgressIndicatorComponentTokens` so as to expose the component tokens for *progress indicators* through any `MISOTheme`.
...
///
/// - Since: 1.0.0
open class BlueCoatThemeProgressIndicatorComponentTokensProvider: AllProgressIndicatorComponentTokensProvider {
    ...
    {
        ML.debug("Init of BlueCoatThemeProgressIndicatorComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "BlueCoatThemeProgressIndicatorComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of AllProgressIndicatorComponentTokensProvider is not here but in Core/MISO/Themes/BlueCoat/Values/ComponentTokens/BlueCoatTheme+ProgressIndicatorComponentTokens.swift
    // This declaration of BlueCoatThemeProgressIndicatorComponentTokensProvider is here also to allow to write documentation.
}
