...
/// - Since: 1.0.0
public typealias DefaultBadgeComponentTokensProvider = BlueCoatThemeBadgeComponentTokensProvider
...
///
/// - Since: 1.0.0
open class BlueCoatThemeBadgeComponentTokensProvider: AllBadgeComponentTokensProvider {
    ...
    {
        ML.debug("Init of BlueCoatThemeBadgeComponentTokensProvider")
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "BlueCoatThemeBadgeComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of BadgeComponentTokens is not here but in Core/MISO/Themes/BlueCoat/Values/ComponentTokens/BlueCoatTheme+BadgeComponentTokens.swift
    // This declaration of BlueCoatThemeBadgeComponentTokensProvider is here also to allow to write documentation.
}
