...
///         // and defined automaticaly in MISOTheme+ColorSemanticTokens extension
///         var bgPrimaryLight: ColorSemanticToken { ColorRawTokens.functionalWhite }
///         var bgPrimaryDark: ColorSemanticToken { ColorRawTokens.functionalDarkGray880 }
///
...
///         // and defined inside MISOTheme+ColorMultipleSemanticToken extension
...
///
///     // Given you want to apply the color token "surfaceBrandPrimary"
///     var body: some View {
...
extension MISOWCAG21Ratio {
    ...
    /// #else
    ///     MISOWCAG21Ratios.misoDebugWCAG21Colors = false
    /// #endif
    /// ```
    nonisolated(unsafe) public static var misoDebugWCAG21Colors: Bool = false
    ...
    /// and *dark* values.
    /// **Checks are done if end only if the `MISOWCAG21Ratios.misoDebugWCAG21Colors` flag is set to true.**
    ...
    {
        guard misoDebugWCAG21Colors else {
            return false
        }
