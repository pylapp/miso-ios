...
/// ``ElevationCompositeSemanticToken`` refers to ``MultipleElevationCompositeRawToken``, which contains for light and dark color schemes `ElevationCompositeRawToken`.
