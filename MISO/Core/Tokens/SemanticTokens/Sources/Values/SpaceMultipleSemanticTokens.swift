...
/// Thus the "real" color semantic tokens are declared in ``SpaceSemanticTokens`` protocol and defined inside `MISOTheme` (to be overridable then by subthemes).
...
///         // declared (in SpaceSemanticTokens.swift) and defined (in MISOTheme+SpaceSemanticTokens.swift) by the tokenator
...
///         // declared (in SpaceMultipleSemanticTokens.swift) and defined (in MISOTheme+SpaceMultipleSemanticTokens.swift) manualy
