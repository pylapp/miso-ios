...
extension WireframeThemeBarComponentTokensProvider: BarComponentTokens {
    ...
    @objc open var colorBgTranslucent: MultipleColorSemanticToken { MultipleColorSemanticToken(light: ColorRawTokens.white800, dark: WireframeBrandColorRawTokens.opacityGrayDark880800) }
    /// Has for value token colors.bgSecondary (= light: "#F7F8FAFF" / dark: "#181C26FF")
