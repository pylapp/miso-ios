...
final class WireframeThemeProgressIndicatorComponentTokensProvider: AllProgressIndicatorComponentTokensProvider {
         ...
         dimensions: AllDimensionSemanticTokensProvider? = nil)
    {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "WireframeThemeProgressIndicatorComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of AllProgressIndicatorComponentTokensProvider is not here but in Core/Themes/Wireframe/Values/ComponentTokens/WireframeTheme+ProgressIndicatorComponentTokens.swift
    // This declaration of WireframeThemeProgressIndicatorComponentTokensProvider is here also to allow to write documentation.
}
