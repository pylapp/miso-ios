...
open class WireframeThemeTypographyComponentTokensProvider: AllTypographyComponentTokensProvider {
    ...
    public init(spaces: AllSpaceSemanticTokensProvider? = nil, colors: AllColorSemanticTokensProvider? = nil) {
        ...
        #if DEBUG
        Self.instanceCount++
        checkInstances(count: Self.instanceCount, for: "WireframeThemeTypographyComponentTokensProvider")
        #endif
    }
    ...
    // the implementation of TypographyComponentTokens is not here but in Core/Themes/Wireframe/Values/ComponentTokens/WireframeTheme+TypographyComponentTokens.swift
    // This declaration of WireframeThemeTypographyComponentTokensProvider is here also to allow to write documentation.
}
