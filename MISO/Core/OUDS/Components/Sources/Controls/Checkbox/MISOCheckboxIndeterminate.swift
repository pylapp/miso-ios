...
// MARK: - MISO Checkbox Indeterminate
...
///
/// In you are looking for a checkbox with only two possible values, refer to ``MISOCheckbox``.
///
/// ## Particular cases
///
/// An ``MISOCheckboxIndeterminate`` can be related to an error situation, for example troubles for a form.
...
///     MISOCheckboxIndeterminate(selection: $selection, accessibilityLabel: "The cake is a lie")
///
///     // A simple checkbox, but is an error context
///     MISOCheckboxIndeterminate(selection: $selection, accessibilityLabel: "The cake is a lie"), isError: true)
///
///     // Never disable an error-related checkbox as it will crash
///     // This is forbidden by design!
///     MISOCheckboxIndeterminate(selection: $selection, accessibilityLabel: "The cake is a lie"), isError: true).disabled(true) // fatal error
/// ```
///
/// - Version: 2.4.0 (Figma component design version)
/// - Since: OUDS 0.12.0
@available(iOS 15, macOS 13, visionOS 1, watchOS 11, tvOS 16, *)
public struct MISOCheckboxIndeterminate: View {
    ...
    ///
    /// ```swift
    ///     MISOCheckboxIndeterminate(selection: $state, accessibilityLabel: LocalizedStringKey("select_all"), bundle: Bundle.module)
    /// ```
    ///
    ...
    ///
    /// ```swift
    ///     MISOCheckboxIndeterminate(selection: $state, accessibilityLabel: "Select all")
    /// ```
    ///
    /// **The design system does not allow to have both an error situation and a disabled state for the component.**
    ///
