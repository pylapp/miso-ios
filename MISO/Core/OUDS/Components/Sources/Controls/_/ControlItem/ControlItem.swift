...
/// This internal component displays the indicator and defines the layout as a SwiftUI button through the `MISOInteractionButton`.
struct ControlItem: View {
    ...
    var body: some View {
        MISOInteractionButton(isReadOnly: layoutData.isReadOnly) {
            #if os(iOS)
