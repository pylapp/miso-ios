...
/// Use for tokens providers like `BlueCoatThemeListItemComponentTokensProvider`.
///
/// - Since: OUDS 3.0.0
public protocol ListItemComponentTokens {
    ...
    var colorBgBadgeSafetyArea: MultipleColorSemanticToken { get }
    ...
    var spacePaddingBlockSlotTextContainer: SpaceSemanticToken { get }
    var spacePaddingBlockBottomSlotListItemContainer: SpaceSemanticToken { get }
    var spacePaddingBlockTopAlignmentTopTextContainerSmall: SpaceSemanticToken { get }
    var spacePaddingBlockTopAlignmentTopTextContainerDefault: SpaceSemanticToken { get }
    var spacePaddingBlockTopAlignmentTopCounterweightSmall: SpaceSemanticToken { get }
    var spacePaddingBlockTopAlignmentTopCounterweightDefault: SpaceSemanticToken { get }
    ...
    var sizeMaxSizeLeadingTrailingSlot: SizeSemanticToken { get }
