...
/// Any opacity semantic token must be declared there as providers like `BlueCoatThemeOpacitySemanticTokensProvider` will then expose them through `MISOTheme`.
///
/// - Since: OUDS 0.8.0
