...
open class BlueCoatThemeColorSemanticTokensProvider { }
...
extension BlueCoatThemeColorSemanticTokensProvider: ColorSemanticTokens {
    ...
    @objc open var bgSecondary: ColorSemanticToken { BlueCoatBrandColorRawTokens.royalBlue200 }
    @objc open var bgTertiary: ColorSemanticToken { bgSecondary }
}

// An instance of BlueCoatThemeColorSemanticTokensProvider will be assigned to MISOTheme as AllColorSemanticTokensProvider
```
...
The semantic tokens are declared through protocols. These protocols will be then implemented by the providers in higher level (i.e. theme level like *BlueCoatTheme*).
...
Type aliases are also defined to merge protocols for the same tokens groups. Thus the `MISOTheme` will contain wrappers exposed and use through a subset of protocols.
...
extension BlueCoatThemeColorSemanticTokensProvider: ColorMultipleSemanticTokens {
...
open class MISOTheme: @unchecked Sendable {
...
// Do not forget in your app to use the `MISOThemeableView` for your theme, e.g. `BlueCoatTheme`
@main
