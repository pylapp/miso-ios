...
/// - border radius value must be a factor of `BorderRawTokens.base`
/// - border radius values must be all different
/// - border width must not be negative value
/// - border width value must be a factor of `BorderRawTokens.base`
...
struct BorderRawTokensTests {
    ...
    @Test func widthRawToken0MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width0, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken25MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width25, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken50MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width50, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken75MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width75, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken100MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width100, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken125MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width125, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken150MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width150, factor: BorderRawTokens.base)
    }
    ...
    @Test func widthRawToken200MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.width200, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken0MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius0, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken25MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius25, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken50MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius50, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken75MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius75, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken100MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius100, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken150MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius150, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken200MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius200, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken300MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius300, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken400MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius400, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken500MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius500, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken600MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius600, factor: BorderRawTokens.base)
    }
    ...
    @Test func radiusRawToken800MultipleOfBase() throws {
        TestsUtils.assertMultipleOf(BorderRawTokens.radius800, factor: BorderRawTokens.base)
    }
