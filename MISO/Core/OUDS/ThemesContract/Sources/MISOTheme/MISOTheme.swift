...
///
/// **Warning: You are not supposed to use this abstract default theme directly. Please prefer a concrete theme like `BlueCoatTheme` instead**
/// Prefer a theme like `BlueCoatTheme`, or your own subclass.
///
...
open class MISOTheme: @unchecked Sendable, Equatable {
    ...
    /// The `Bundle` of the effective theme (e.g. `BlueCoatTheme`, or your own theme) where resources can be loaded.
