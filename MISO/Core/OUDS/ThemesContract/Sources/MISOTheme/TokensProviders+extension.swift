...
extension TokensProvider {
    ...
    public func checkInstances(count: Int, for providerName: String) {
        ...
        ML.warning("🧮 There are \(count) instances of \(providerName), it should be unique! If this warning does not occur during tests, feel free to submit a bug: https://github.com/Orange-OpenSource/miso-ios/issues")
    }
