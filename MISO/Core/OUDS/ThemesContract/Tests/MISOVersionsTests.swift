...
struct MISOVersionsTests {
    ...
    // MARK: - Tests - Themes versions - BlueCoat

    @Test func themeBlueCoatCoreVersionMustBeConform() throws {
        TestsUtils.assertMatches(MISOVersions.themeBlueCoatCoreVersion, regexp: Self.misoVersionsFormat)
    }

    @Test func themeBlueCoatBrandVersionMustBeConform() throws {
        TestsUtils.assertMatches(MISOVersions.themeBlueCoatBrandVersion, regexp: Self.misoVersionsFormat)
    }
